    ...
    <main className='min-h-screen auth-background py-6 flex flex-col'>
      ...
      <div className='flex-1 flex flex-col justify-between px-4 '>
        ...
        <div className='px-[10px] flex flex-col gap-4'>
          <button className='w-full bg-green-500 rounded-[4px] px-3 py-[5px] text-white text-base leading-[20px] text-center border-[1px] border-[#89D185] '>
            Ir para o WhatsApp
          </button>
          <Link
            to='/'
            className='w-full bg-white rounded-[4px] px-3 py-[5px] text-primary-500 text-base leading-[20px] text-center border-[1px] border-primary-500'
          >
            Acessar plataforma
          </Link>
        </div>
